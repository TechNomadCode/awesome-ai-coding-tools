...
- **[AI Product Development Toolkit](https://github.com/TechNomadCode/AI-Product-Development-Toolkit)** – Free prompt templates that take a project from user research and a PRD to an MVP plan, test plan and v0 design prompt, plus Claude Code rules and permission guardrails.
